...
import { useMap } from "./composables/use-map.ts";
import { usePopup } from "./composables/use-popup.ts";
...
<template>
  <Teleport :to="container">
    <PopupShell variant="popover" :close-button="closeButton" :class="$props.class" @close="popup?.remove()">
      <slot />
    </PopupShell>
  </Teleport>
</template>
